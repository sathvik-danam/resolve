...
ALTER TABLE `posts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_categories_posts_category_id` (`category_id`),
  ADD KEY `fk_subcategories_posts_subcategory_id` (`subcategory_id`),
  ADD KEY `fk_cities_posts_city_id` (`city_id`);
