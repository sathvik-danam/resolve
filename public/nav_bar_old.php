...
<div id="rsss-1234">
    <nav class="bg-white border-gray-200 w-full"  style="height: 100px; border: 1px solid #f0f;"  >
   
    <div  style="border: 1px solid #ff0;"  class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
...
<?php } ?>
<div id="login_menu" style="position: absolute; top: 10px; left: -60px; background-color: white; border: 1px solid #000; width: 200px;">
...
<div style="display: inline; float: right;"><a href="?logout">Logout</a></div>
                ...
                <button data-collapse-toggle="navbar-user" type="button" class="inline-flex items-center p-2 w-10 h-5 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-user" aria-expanded="false">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul class="flex flex-col font-medium p-2 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white  dark:border-gray-700">
                    <li>
                        <a href="#" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="Professional.php" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue md:dark:hover:bg-transparent dark:border-gray-700">Become A Professional</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="services.php" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue md:dark:hover:bg-transparent dark:border-gray-700">Service</a>
                    </li>
                </ul>
            </div>
        </div>
